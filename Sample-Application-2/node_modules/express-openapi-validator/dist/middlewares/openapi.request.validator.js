...
class RequestValidator {
    ...
    buildMiddleware(path, pathSchema, contentType) {
        ...
        const securityQueryParameter = this.getSecurityQueryParams(usedSecuritySchema, this._apiDocs.components.securitySchemes);
        ...
        return (req, res, next) => {
            ...
            const reqToValidate = Object.assign(Object.assign({}, req), { cookies: req.cookies
